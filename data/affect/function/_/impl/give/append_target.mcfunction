...
data modify storage affect:var give[-1].append.effect_entry.id set from storage affect:in give.id
data modify storage affect:var give[-1].append.effect_entry.data set from storage affect:in give.data
...
# may not be necessary, included for safety
data remove storage affect:var give[-1].append
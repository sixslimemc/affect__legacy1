...
# get task
function affect:_/impl/give/duplicate.1 with storage affect:var give.modify.effect
...
function affect:_/impl/give/duplicate.3 with storage affect:var give.modify.with